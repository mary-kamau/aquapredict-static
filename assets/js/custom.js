...
function showRegisterForm(){
    ...
    $('.loginBox').fadeOut('fast',function(){
        ...
        $('.modal-title').html('Start Your AquaPredict Journey Today!');
        $('.modal-subtitle').html('Become part of the AquaPredict community today and dive into a world of detailed performance analysis and tailored training plans.');
    });
...
function showLoginForm(){
    ...
    $('#loginModal .registerBox').fadeOut('fast',function(){
        ...
        $('.modal-title').html('Sign in to <span>AquaPredict</span>');
