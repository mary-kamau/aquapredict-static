        ...
        <div class="row grid-md">
            <div class="col-sm-4">
                <div class="pricing-tab">
                    <p class="price">£0.00<span>/m</span></p>
                    <h4>Standard Tier</h4>
                    <ul class="pricing-features">
                        <li>Basic Performance Analysis</li>
                        <li>Access to fundamental AI-driven analytics. Providing insights on basic performance metrics.</li>
                    </ul>
            ...
            <div class="col-sm-4">
                <div class="pricing-tab">
                    ...
                    <p class="price">£9.99<span>/m</span></p>
            ...
            <div class="col-sm-4">
                <div class="pricing-tab">
                    <p class="price">£19.99<span>/m</span></p>
                    <h4>Elite Tier</h4>
                    <ul class="pricing-features">
                        <li>Comprehensive Performance Analysis</li>
                        <li>Advanced AI analysis, providing intricate details on all aspects of
                            swimming performance.</li>
                    </ul>
