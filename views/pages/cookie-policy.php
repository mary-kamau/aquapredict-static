...
<body style="padding-top: 60px;">
    ...
    <div class="container content" style="margin-bottom:20px;">
        <p>Cookies are small text files that are placed on your computer by websites that you visit. 
            ...
            Our aim in using Cookies is to be able to make the site better for you.</p>

        <p>The cookies may identify the following information when you use our website:</p>
        <ul>
            <li>technical information, including the Internet protocol (IP) address used to connect your computer to the Internet, 
                your login information, browser type and version, time zone setting, browser plug-in types and versions, 
                operating system type, version and platform, device type, version or serial number, screen resolution and number of CPU cores;</li>
            <li>information about your visit, including the full Uniform Resource Locators (URL) clickstream to, 
                through and from our site (including date and time stamps)</li>
            <li>products you viewed or searched for;</li>
            <li>page response times, download errors, length of visits to certain pages, page interaction information (such as scrolling, clicks, and mouse-overs)</li>
            <li>and methods used to browse away from the page and any phone number used to call our customer service number.</li>
        </ul>
